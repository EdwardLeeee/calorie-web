/* ================= 後端 base URL ================= */
//const AUTH = 'http://127.0.0.1:5005';   // auth_admin.py
//const API = 'http://127.0.0.1:5006';   // admin_app.py
const AUTH = '/auth_admin';   // auth_admin.py
const API = '/admin_app';   // admin_app.py
